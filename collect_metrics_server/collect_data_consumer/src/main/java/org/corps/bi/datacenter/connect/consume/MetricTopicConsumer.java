...
public class MetricTopicConsumer implements Runnable{
	...
	public MetricTopicConsumer(ConnectMetricConfig connectMetricConfig,Properties metricProperties) {
		super();
	...
	private void subscribe(){
		...
		try {
			...
			this.metricPersister=new MetricPersister(connectMetricConfig);
